...
class _ChangePasswordPageState extends State<ChangePasswordPage> {
  ...
  bool _validateFields() {
    ...
    if(_newPasswordController == _oldPasswordController){
      _showSnackBar("Старый и новый пароли не должны совпадать");
    }
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      if (loginProvider.userRole == 'employer') {
      ...
      if (loginProvider.userRole == 'finder') {
        Navigator.pushReplacement(
          context,
