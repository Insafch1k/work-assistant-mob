...
class AdvertisementFavorite extends StatefulWidget {
  final FavoriteAdvertisement ad;

  const AdvertisementFavorite({Key? key, required this.ad}) : super(key: key);

  @override
  State<AdvertisementFavorite> createState() => _AdvertisementFavoriteState();
}

class _AdvertisementFavoriteState extends State<AdvertisementFavorite> {
  bool _isLiked = false;
  ...
  void initState() {
    super.initState();
    _isLiked = widget.ad.is_favorite;
    _isUrgent = widget.ad.is_urgent;
  }
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final buttonWidth = (constraints.maxWidth - 30) / 2; // 30 = 10px отступ между кнопками + 20px боковые отступы
        // Ширина для текстового контента (минус отступы и иконки)
        final contentWidth = constraints.maxWidth - 40; // 40 = 20px слева + 20px справа
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 10),
                              SizedBox(
                                width: contentWidth - 110, // Учитываем иконку и отступ
                                child: Text(
                                  widget.ad.address,
                                  overflow: TextOverflow.ellipsis,
                                  style: const TextStyle(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => DetailedAdvertisementPage(
